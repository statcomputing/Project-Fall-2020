...
Currently, the applicational part of the project on 3 real data sets was accomplished. The R-Script to calculate $\hat I$ and $\hat G$ was implemented and those metrics were computed for the data sets.   
